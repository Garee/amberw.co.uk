  ...
  head: {
    ...
    link: [
      ...
      },
      {
        rel: 'preload',
        as: 'style',
        href: 'https://fonts.googleapis.com/css2?family=Otomanopee+One:wght@400;600;700&display=swap'
      },
      {
        rel: 'stylesheet',
        href: 'https://fonts.googleapis.com/css2?family=Otomanopee+One:wght@400;600;700&display=swap',
    ...
    noscript: [
      {
        innerHTML:
          '<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Otomanopee+One:wght@400;600;700&display=swap">'
      }
    ],
